...
('categoria',                   20,'534f47530237478d09571178e6a31524'),
...
SET @crc = '';
    SELECT @crc = LOWER(CONVERT(VARCHAR(32),HashBytes('MD5',CONCAT_WS('#',@crc, categoria_id, categoria_nombre,categoria_nombre_es)),2))
